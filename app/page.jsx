    ...
    return (
        <>
            ...
            <main style={{ paddingTop: navbarHeight }} className='w-full'>
                <section className='relative w-full bg-blue-light'>
                    <div className='flex flex-col gap-6 bg-[url("../public/hero.svg")] bg-contain bg-no-repeat bg-right px-16 py-12'>
                        <div className='w-1/2 flex flex-col gap-3'>
                            <h2 className='font-bold text-iris uppercase'>Magang</h2>
                            <p>Magang adalah sebuah sistem informasi geografis yang menyajikan data lowongan magang dalam bentuk peta<br /><br />Aplikasi ini akan menampilkan sebaran data lowongan magang berdasarkan lokasi perusahaannya dan dapat menampilkan jumlah data per Kabupaten/Kota di Indonesia</p>
                        </div>
                ...
                <section className='flex flex-col justify-center px-16 pt-8 pb-12 gap-7'>
                    ...
                    <div className='flex gap-11 justify-center items-start'>
                        <div className='flex flex-col gap-3 px-2 justify-center text-center'>
                            <div className='w-full flex justify-center'>
                                <Image src={FeatureImgA} alt='feature-image' className='rounded-md' />
                            </div>
                        ...
                        <div className='flex flex-col gap-3 px-2 justify-center text-center'>
                            <div className='w-full flex justify-center'>
                                <Image src={FeatureImgB} alt='feature-image' className='rounded-md' />
                            </div>
                        ...
                        <div className='flex flex-col gap-3 px-2 justify-center text-center'>
                            <div className='w-full flex justify-center'>
                                <Image src={FeatureImgC} alt='feature-image' className='rounded-md' />
                            </div>
                            <h4>Filter Data</h4>
            ...
            <footer className='w-full px-6 py-1 flex justify-center items-center bg-neutral-dark'>
